...
function DrawerCaseStudy(props) {
  const {
    title,
    width,
    onClose,
  ...
  const [OldInputList, setOldInputList] = useState(
    FltCaseStudyList.subLevelTranslations
  );

  const [inputList, setInputList] = useState([]);

  const [ActiveModule, setActiveModule] = useState({
    subModuleType: FltCaseStudyList.subModuleType,
    moduleName: FltCaseStudyList.moduleName,
    taskUrl: FltCaseStudyList.taskUrl,
    urlFormat: FltCaseStudyList.urlFormat,
  });
        ...
        <Form id='InsertForm' className='text-left' onSubmit={handleSubmit}>
          {
            <div className='m-auto'>
              <TextField
                ...
                name='taskUrl'
                defaultValue={
                  FltCaseStudyList.taskUrl !== " "
                    ? FltCaseStudyList.taskUrl
                    : "No Link"
                }
                required
                disabled={DrawerType === "View" ? true : false}
                onChange={(e) => handleChangeCaseStudy(e)}
              />
              ...
              >
                ...
                <Select
                  ...
                  defaultValue={FltCaseStudyList.urlFormat}
                  onChange={(e) => handleChangeCaseStudy(e)}
                  label='URL Format'
                  name='urlFormat'
                  disabled={DrawerType === "View" ? true : false}
...
export default DrawerCaseStudy;
